...
export class Application extends Entity {
  ...
  get surfaceAreaInSQMTR(): BigInt {
    let value = this.get("surfaceAreaInSQMTR");
    return value!.toBigInt();
  }

  set surfaceAreaInSQMTR(value: BigInt) {
    this.set("surfaceAreaInSQMTR", Value.fromBigInt(value));
  }
