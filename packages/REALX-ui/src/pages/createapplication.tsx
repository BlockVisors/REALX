                ...
                >
                  ...
                  >
                    <Stack spacing={4}>
                      ...
                      <FormControl id="surfaceAreaInSQMTR" isRequired>
                        <FormLabel>SurfaceAreaInSQMTR</FormLabel>
                        <Input
                          value={applicationForm.surfaceAreaInSQMTR}
                          onChange={handleApplicationForm}
