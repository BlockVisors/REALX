        ...
        <Stack direction={{ base: "column", md: "row" }}>
          <Stack direction="column" spacing={10} justifyContent="center">
            ...
            <Text
              ...
              maxW="700px"
            >
              Investors can invest in real estate projects listed on our platform. The borrower will be
              able to take profits by converting his real estate to REALX NFT's. These REALX NFT's can be used
              as collateral.
            </Text>
